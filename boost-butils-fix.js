...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/BoostCanvas.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Series/Series.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js'], _modules['Extensions/Boost/BoostUtils.js']], function (Chart, Color, H, Series, SeriesRegistry, U, butils) {
        /* *
         *
         *  License: www.highcharts.com/license
        ...
        var initCanvasBoost = function () {
            ...
            extend(Series.prototype, {
                ...
                renderCanvas: function () {
                    ...
                    butils.eachAsync(sdata, function (d, i) {
                        var x,
                            y,
                            clientX,
                            plotY,
